...
2. **Classifier-free guidance (CFG)**:
    - $s(\epsilon_\theta(z_t, c, t) - \epsilon_\theta(z_t, \phi, t))$
...
> "Given a real reference video, the corresponding motion representation HtαH_{t_\alpha}Htα​​ is obtained by performing a single noise-adding and denoising step."
> 
